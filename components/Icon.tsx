...
const ICONS: { [key: string]: React.ReactElement } = {
    'desktop': <><rect width="18" height="12" x="3" y="4" rx="2"/><line x1="12" x2="12" y1="16" y2="20"/><line x1="8" x2="16" y1="20" y2="20"/></>,
    ...
    'dumbbell': <><path d="m6.5 6.5-1-1"/><path d="m21 21-1-1"/><path d="m3 3 7 7"/><path d="m14 14 7 7"/><path d="m18 2-1 1"/><path d="m7 21-1 1"/><path d="m4 16 2-2"/><path d="m16 4 2-2"/><path d="m18 10 2-2"/><path d="M10 18l-2 2"/><rect width="18" height="7" x="3" y="8.5" rx="2" transform="rotate(-45 12 12)"/></>,
    'presentation': <><path d="M2 3h20"/><path d="M4 7v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7"/><path d="M12 21V7"/><path d="m7 12 5-3 5 3"/><path d="M7 16s.5-1 5-1 5 1 5 1"/></>,
    'hanger': <><path d="M13.2 4H10a2 2 0 1 0-4 0h9.2a2 2 0 1 1-3.2 2M6 8l.9 2.9a2 2 0 0 0 2 1.6h6.2a2 2 0 0 0 2-1.6L18 8"/></>,
    ...
    'gamepad': <><path d="M16.5 8.5h-9a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1z"/><path d="M9 11.5v-3a.5.5 0 0 1 1 0v3a.5.5 0 0 1-1 0z"/><rect x="2" y="6" width="20" height="12" rx="3"/><path d="M14 10.5h1.5v1.5H14zM16 12.5h1.5v1.5H16z"/></>,
